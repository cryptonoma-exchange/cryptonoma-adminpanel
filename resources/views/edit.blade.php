				...
				<div class="card-body">
					...
					<form method="post" action="{{ url('admin/instant_commissionupdate') }}" autocomplete="off">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" name="buyamount" class="form-control" value="{{ $BuySellCommission->buy != NULL ? display_format($BuySellCommission->buy,8) : '0' }}"/><i class="form-group__bar"></i>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" name="sellamount" class="form-control" value="{{ $BuySellCommission->sell != NULL ? display_format($BuySellCommission->sell,8) : '0' }}"/><i class="form-group__bar"></i>
