...
<div class="content__inner">
	...
	<div class="card">
		<div class="card-body"> 
			<form method="post" autocomplete="off" action="{{ url('admin/update_listingstatus') }}">
			    {{ csrf_field() }}
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
						   <textarea class="ckeditor" name="listingstatus">
						        @if(is_object($listingstatus) > 0)
                                    @php $data = str_replace(array("\r\n", "\r", "\n"), "<br />", $listingstatus->listingstatus) @endphp
                                    {{ $data }}
                                @endif
						   </textarea>
						</div>
