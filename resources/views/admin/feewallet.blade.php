      ...
      <div class="card-body">
        ...
        {{ csrf_field() }}
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="input-group">
                <input type="text" name="address" class="form-control" value="{{ $data->address }}" id="myInput" />
                <i class="form-group__bar"></i> </div>
            </div>
            <div class="col-md-4">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <input type="text" name="balance" class="form-control" value="{{ $data->balance }}" readonly="">
                <i class="form-group__bar"></i> </div>
            </div>
          </div>
          <!-- 
