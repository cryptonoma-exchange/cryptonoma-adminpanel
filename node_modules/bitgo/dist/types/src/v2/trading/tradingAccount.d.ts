...
export declare class TradingAccount {
     ...
     */
    calculateSettlementFees(params: CalculateSettlementFeesParams, callback?: NodeCallback<SettlementFees>): Bluebird<SettlementFees>;
    /**
     ...
     */
    signPayload(params: SignPayloadParameters, callback?: any): Bluebird<string>;
