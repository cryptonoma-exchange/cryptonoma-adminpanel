...
export declare class Trx extends BaseCoin {
     ...
     */
    signTransaction(params: TronSignTransactionOptions, callback?: NodeCallback<SignedTransaction>): Bluebird<SignedTransaction>;
    /**
     ...
     * @param callback
     */
    explainTransaction(params: ExplainTransactionOptions, callback?: NodeCallback<TronTransactionExplanation>): Bluebird<TronTransactionExplanation>;
}
