...
class BalanceErc20Update extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'deposit_update:erc20';
        ...
        foreach ($addresses as $address) {
            ...
            if ($useraddress) {
                foreach ($tokens as $token) {
                    ...
                    $url = "http://api.etherscan.io/api?module=account&action=tokentx&address={$useraddress}&&contractaddress={$contract_address}&startblock=0&endblock=99999999&sort=asc&apikey={$apikey}";
