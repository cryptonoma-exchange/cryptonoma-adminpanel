	...
	<div class="container">
		<div class="col-md-8">	
		  ...
		  <div class="sitelogo">
			...
			<div class="btn-bg">
			<a href="<?php echo e(url('admin/dashboard')); ?>">Go To Dashboard</a>
			</div>				
			</div>		
		</div>
	</div>		
</body>
</html><?php /**PATH /home/admin/web/hd83s.cryptonoma.com/public_html/resources/views/errors/404.blade.php ENDPATH**/ ?>