...
<body data-sa-theme="7">
    <main class="main">
            ...
            <div class="scrollbar-inner">
                ...
                <ul class="navigation">
                    ...
                    <?php endif; ?>
                     ...
                     <?php if(in_array('read', explode(',', $AdminProfiledetails->support))): ?>
                    <li class="@photogalleryactive"><a <?php if($active=='time-settings' ): ?> class="active" <?php endif; ?> href="<?php echo e(url('/admin/time-settings')); ?>"><i class="zmdi zmdi-time"></i> Time Settings
                    </a></li>
                    <?php endif; ?>

                     <?php if(in_array('read', explode(',', $AdminProfiledetails->support))): ?>
                    <li class="@photogalleryactive"><a <?php if($active=='plans' ): ?> class="active" <?php endif; ?> href="<?php echo e(url('/admin/plans')); ?>"><i class="zmdi zmdi-input-composite"></i> Manage Plans
                    </a></li>
                    <?php endif; ?>

                    <?php if(in_array('read', explode(',', $AdminProfiledetails->support))): ?>
                    <li class="@photogalleryactive"><a <?php if($active=='referral-setting' ): ?> class="active" <?php endif; ?> href="<?php echo e(url('/admin/referral-setting')); ?>"><i class="zmdi zmdi-device-hub"></i> Referral Levels
                    </a></li>
                    <?php endif; ?>


                    <?php if(in_array('read', explode(',', $AdminProfiledetails->support))): ?>
                    <li class="@photogalleryactive"><a <?php if($active=='stages' ): ?> class="active" <?php endif; ?> href="<?php echo e(url('/admin/stages')); ?>"><i class="zmdi zmdi-device-hub"></i> ICO /STO Stage
                    </a></li>
                    <?php endif; ?>
        ...
        <?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\cryptonoma-adminpanel\resources\views/layouts/header.blade.php ENDPATH**/ ?>