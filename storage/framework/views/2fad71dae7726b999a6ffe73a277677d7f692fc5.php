...
<tr><td align='left' style='padding-top:0px;'>&nbsp;</td><td style='text-align:left;font-size:15px;color:#000;padding-top:0px;'>Your <?php echo e($details['amount']); ?> <?php echo e($details['coin']); ?> Deposit Request has been approved by admin . Kindly login your <?php echo e(config('app.name')); ?> account and check <?php echo e($details['coin']); ?> deposit history </td><td align='left' style='padding-top:0px;'>&nbsp;</td></tr>
<?php else: ?>
<tr><td align='left' style='padding-top:0px;'>&nbsp;</td><td style='text-align:left;font-size:15px;color:#000;padding-top:0px;'>Your <?php echo e($details['amount']); ?> <?php echo e($details['coin']); ?> Deposit Request has been cancelled by admin . Kindly login your <?php echo e(config('app.name')); ?> account and check <?php echo e($details['coin']); ?> deposit history </td><td align='left' style='padding-top:0px;'>&nbsp;</td></tr>
<?php endif; ?>
...
<?php /**PATH /home/admin/web/hd83s.cryptonoma.com/public_html/resources/views/email/deposit.blade.php ENDPATH**/ ?>