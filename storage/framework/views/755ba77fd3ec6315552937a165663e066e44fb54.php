				...
				<div class="row">
					<div class="col-md-6 tg-select-left">
						<select class="form-control custom-s-left" onchange="pageredirect(this)">
							<option value="<?php echo e(url('admin/sell_tradehistory/' . $tradepair->coinone . '_' . $tradepair->cointwo . '/limit')); ?>"
								<?php if($order_type == 1): ?> selected <?php endif; ?>>Limit</option>
							<option value="<?php echo e(url('admin/sell_tradehistory/' . $tradepair->coinone . '_' . $tradepair->cointwo . '/market')); ?>"
					...
					<div class="col-md-6 tg-select">
						...
						<select onchange="location = this.value;" class="form-control custom-s">
							<?php if(isset($pairs)): ?>
								<option value="<?php echo e(url('admin/sell_tradehistory/' . $tradepair->coinone . '_' . $tradepair->cointwo . '/' . $type)); ?>">
								...
								<?php $__currentLoopData = $pairs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coinones): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($coinones->coinone . '_' . $coinones->cointwo != $tradepair->coinone . '_' . $tradepair->cointwo): ?>
										<option value="<?php echo e(url('admin/sell_tradehistory/' . $coinones->coinone . '_' . $coinones->cointwo . '/' . $type)); ?>">
					...
					<div id="buyo" class="tab-pane fade in active show">
						<div class="table-responsive" style="overflow-x: auto;white-space: nowrap;">
							<table class="table" id="dows">
								...
								<tbody>
									<?php $__empty_1 = true; $__currentLoopData = $selltrade; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
										<tr>
											<td><?php echo e($loop->index + $selltrade->firstItem()); ?></td>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/web/hd83s.cryptonoma.com/public_html/resources/views/tradehistory/selltradehistory.blade.php ENDPATH**/ ?>